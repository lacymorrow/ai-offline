...
export const isSpam = async ({ content, sender }: z.infer<typeof isSpamSchema>) => {
	const messages: ChatCompletionMessageParam[] = [
		{
			role: "system",
			content: "You are an assistant that determines if an email is spam or a phishing attempt.",
		},
		{
			role: "user",
